...
from data.dataset import convert_to_voc
...
def do_voc_eval():
    ...
    convert_to_voc(root_path=args.annopath,image_path=args.image_root)
    for _class in range(1, args.num_classes + 1):
        rec, prec, ap = voc_eval(
            detpath='./result/result_{}.txt',
            annopath= './portable/VOCdevkit/VOC2012/Annotations/{}.xml',
